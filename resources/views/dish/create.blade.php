...
@section('content')
    <div class="container">
        ...
        <form class="glass-form" action="{{ route('admin.dish.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="mb-3">
                ...
                <input minlength="3" maxlength="200" required type="text"
            ...
            <div class="mb-3">
                ...
                <select required type="select" class="form-select @error('visible') is-invalid @enderror" name="visible" @>
                    <option @if (old('visible')) selected @endif value="1">Si</option>
                    <option @if (!old('visible')) selected @endif value="0">No</option>
                    @error('visible')
                        <div>
            ...
            <div class="w-100 d-flex align-items-center justify-content-end">
                <button type="submit" class="btn btn-warning">Aggiungi Piatto</button>
            </div>
        </form>
    </div>
@endsection
