...
<head>
    ...
    <link rel="icon" type="image/svg+xml" href="/images/deliveboo.jpg" />
    <title>Deliveboo for restorator</title>
        ...
        <nav class="navbar navbar-expand-md navbar-light bg-nav shadow-sm">
            <div class="container">
                <a class="navbar-brand d-flex align-items-center" href="{{ url('/') }}">
                    <div class="logo">
                        <img class="img-fluid" src="{{ asset('images/deliveboo.jpg') }}" alt="logo">
                    </div>
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    ...
                                    <a class="dropdown-item"
                                        href="{{ route('admin.restaurant.index') }}">{{ __('Restaurant') }}</a>
